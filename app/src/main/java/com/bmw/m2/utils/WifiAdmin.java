...
//        }
    ...
    public void startScan() {
        ...
        Log.d("MyIntentService", "startScan: "+mWifiList.size());
        // 得到配置好的网络连接
...
//        removeConfig(getSSID());
    ...
    public WifiConfiguration CreateWifiInfo(String SSID, String Password, int Type) {
        Log.d("MyIntentService", "CreateWifiInfo: ssid = " + SSID + " password = " + Password);
//        removeConfig(SSID);
        ...
        if (tempConfig != null) {
            Log.d("MyIntentService", "CreateWifiInfo: tempConfig != null!!! ssid = " + tempConfig.SSID);
