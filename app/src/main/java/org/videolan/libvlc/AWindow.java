...
public class AWindow implements IVLCVout {
    ...
    private class SurfaceHelper {
        ...
        private void attachSurfaceView() {
            Log.d(TAG, "myAdd log : attachSurfaceView: ");
        ...
        private void attachSurface() {
            Log.d(TAG, "myAdd log : attachSurface: ");
        ...
        private final SurfaceHolder.Callback mSurfaceHolderCallback = new SurfaceHolder.Callback() {
            ...
            public void surfaceDestroyed(SurfaceHolder holder) {
                Log.d(TAG, "myAdd log : surfaceDestroyed: ");
                onSurfaceDestroyed();
            }
        };
        ...
        private TextureView.SurfaceTextureListener createSurfaceTextureListener() {
            return new TextureView.SurfaceTextureListener() {
                ...
                public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
                    Log.d(TAG, "myAdd log : onSurfaceTextureDestroyed: ");
                    onSurfaceDestroyed();
                    return true;
                }
    ...
    public void detachViews() {
        Log.d(TAG, "myAdd log : detachViews: ");
        if (mSurfacesState.get() == SURFACE_STATE_INIT)
            return;
    ...
    private void onSurfaceDestroyed() {
        Log.d(TAG, "myAdd log : onSurfaceDestroyed: ");
        detachViews();
    }
